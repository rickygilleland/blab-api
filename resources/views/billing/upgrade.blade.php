    ...
    <div class="row justify-content-center">      
        <div class="card shadow-sm w-75 mb-5">
                <div class="card-body p-4 text-center">
                    ...
                    <p class="pb-3" style="font-size:1rem">Your account currently has {{ $plan_quantity }} teammates, for a total of ${{ $total }}/month.</p>
                    ...
                    <hr>
                    <div id="termsMessage1"><p class="pt-1">When you click the <strong>Confirm Subscription</strong> button, your card will be charged <strong>${{ $total }}</strong> immediately and your subscription will be begin. Your selected plan will automatically renew monthly on the same day of the month you are initially billed.</p>
