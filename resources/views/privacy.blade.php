...
@section('content')
	...
	<div class="row">
		...
		<div class="col-md-12 col-12 mx-auto mb-4 mt-4">
            ...
            <p class="lead">This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from https://blab.to (the “Site”).</p>

            <h2 class="h3">PERSONAL INFORMATION WE COLLECT</h2>
            ...
            <h2 class="h3">We collect Device Information using the following technologies:</h2>
    ...
    - “Web beacons,” “tags,” and “pixels” are electronic files used to record information about how you browse the Site.</p>
            ...
            <h2 class="h3">HOW DO WE USE YOUR PERSONAL INFORMATION?</h2>
...
When in line with the preferences you have shared with us, provide you with information or advertising relating to our products or services.</p>
            ...
            <h2 class="h3">SHARING YOUR PERSONAL INFORMATION</h2>
    ...
    BING - https://advertise.bingads.microsoft.com/en-us/resources/policies/personalized-ads</p>
            ...
            <p>For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e-mail at hello@blab.to</p>
