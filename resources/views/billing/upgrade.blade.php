    ...
    <div class="row justify-content-center">      
        <div class="card shadow-sm w-75 mb-5">
                <div class="card-body p-4 text-center">
                    ...
                    <p class="pb-3" style="font-size:1rem">Your account currently has {{ $plan_quantity }} teammates, for a total of ${{ $total }}/month. Your card won't be charged until after the end of the 7 day free trial.</p>
                    ...
                    <input id="coupon-code" placeholder="Coupon Code" class="form-control mb-4 py-4 shadow-sm" type="text">

                    <hr>
                    <div id="termsMessage1"><p class="pt-1">When you click the <strong>Confirm Subscription</strong> button, your 7 day free trial will begin immediately. Your card will be charged <strong>${{ $total }}</strong> in 7 days if you don't cancel before then. Your selected plan will automatically renew monthly on the same day of the month you are initially billed.</p>
